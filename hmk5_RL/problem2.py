...
class Agent(object):
    ...
    def __init__(self, n, n_s, e=0.1):
        ''' Initialize the agent. 
            ...
            Outputs:
                ...
                self.Q: the expected ratio of rewards for pulling each lever at each state, a numpy matrix of
                 shape n_s by n. We initialize the matrix with all-zeros.
                self.c: the counts of the number of times that each lever being pulled given a certain state. a numpy
                matrix of shape n_s by n, initialized as all-zeros.
   ...
   # ----------------------------------------------
    ...
    def update(self,s,a,r):
        ...
        #########################################
        self.c[s, a] += 1.
        self.Q[s, a] = (self.Q[s, a] * (self.c[s, a] - 1) + r) / self.c[s, a]
        #########################################
